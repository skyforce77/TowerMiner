...
import fr.skyforce77.towerminer.api.events.menu.interact.mouse.*;
import fr.skyforce77.towerminer.api.events.menu.interact.window.*;
...
public class Game extends JFrame implements MouseListener, MouseWheelListener, MouseMotionListener, WindowListener, KeyListener {
    ...
    public class GameCanvas extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            if (event.getRender() != null) {
                event.getRender().run(g2d);
            }
