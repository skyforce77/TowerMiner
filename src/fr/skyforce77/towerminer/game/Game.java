...
import fr.skyforce77.towerminer.api.events.menu.interact.mouse.MenuMouseDraggedEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.mouse.MenuMouseEnteredEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.mouse.MenuMouseExitedEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.mouse.MenuMouseMovedEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.mouse.MenuMousePressedEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.mouse.MenuMouseReleasedEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.mouse.MenuMouseWheelMovedEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.window.MenuWindowActivatedEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.window.MenuWindowClosedEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.window.MenuWindowClosingEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.window.MenuWindowDeactivatedEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.window.MenuWindowDeiconifiedEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.window.MenuWindowIconifiedEvent;
import fr.skyforce77.towerminer.api.events.menu.interact.window.MenuWindowOpenedEvent;
	...
	public class GameCanvas extends JPanel {
		...
		public void paintComponent(Graphics g) {
			...
			for(RenderRunnable rd : event.getReplaceRenders())
				rd.run(g2d);
			for(RenderRunnable rd : event.getRenders())
				rd.run(g2d);
